...
| 前端 | http://192.168.19.129:80 | Nginx服务 |
| 后端API | http://192.168.19.129:8080 | Spring Boot |
| 数据库管理 | http://192.168.19.129:8081 | phpMyAdmin |
...
访问 `http://192.168.19.129:80`，查看标题是否变为"电商数据管理系统 v2.0"
